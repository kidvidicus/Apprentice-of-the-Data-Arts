...
-- NOTICE: I wasn't happy with the results from below. I decided to go with a different approach (depicted in the queries above) exploring franchises and their sequels. Keeping these old queries for reference. I may want to come back to this.
